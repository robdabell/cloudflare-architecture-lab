...
export function DashboardPage() {
  ...
  return (
    <>
      ...
      <Link
        to="/sports-car-finder"
        className="mt-3 flex min-h-20 items-center gap-4 rounded-2xl border border-slate-300 bg-slate-900 p-5 text-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
      >
        <span className="grid size-12 shrink-0 place-items-center rounded-xl bg-accent text-white">
          <CarFront className="size-6" aria-hidden />
        </span>
        <span>
          <strong className="block">Try the Sports Car Finder</strong>
          <span className="text-sm text-slate-300">
            Match your driving brief to a D1-backed catalogue.
          </span>
        </span>
      </Link>
      <Card className="mt-6">
