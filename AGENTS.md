...
9. Separate Cloudflare resources by environment using the `cloudflare-architecture-lab-*` namespace; previews must never use production data resources.
...
3. Run formatting, linting, type checking, tests, relevant migrations, and a production build.
